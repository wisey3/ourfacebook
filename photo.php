...
<html>
	<head>
  	...
  	<body>
	    ...
	    <div>
	    <a href="collection.php" style="display: inline; float:left;"><img src="backarrow.png" height="50px" /></a>
	    </div>
    		...
    		<div id="collectionGrid" style="background-color:white; width:920px;">
    			...
    			<?php
					...
					while ($image = mysqli_fetch_array($photos)) {
					    ...
					    $photoName = mysql_real_escape_string($image['refLoc']); //needs to be the path of where it was stored.
					    //$albumNo = $image['albumID'];

					    echo "<td><div style='margin:7px; width:170px; height:170px; background-color:skyblue; float:left; box-shadow: 1px 2px 4px rgba(0, 0, 0, .5); overflow:hidden;'>";
		...
		<form action="delete.php?type=Collection&albumID=<?php echo $albumId ?>" method="post">
