...
--
ALTER TABLE `comment`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD KEY `photoID` (`photoID`);

--
-- Indexes for table `photo`
--
ALTER TABLE `photo`
 ADD PRIMARY KEY (`photoID`), ADD UNIQUE KEY `photoID_2` (`photoID`), ADD KEY `photoID` (`photoID`), ADD KEY `albumID` (`albumID`);
